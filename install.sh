...
echo $'\e[35m'"Gost Ip6 Script"$'\e[0m'
...
systemctl enable sysctl-custom
    ...
    wget -O /tmp/gost.tar.gz https://github.com/go-gost/gost/releases/download/v3.0.0-nightly.20250821/gost_3.0.0-nightly.20250821_linux_amd64.tar.gz
